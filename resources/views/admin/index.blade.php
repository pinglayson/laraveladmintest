...
<head>
    ...
    <!-- Custom style -->
    <link rel="stylesheet" href="{{ admin_asset("vendor/laravel-admin/datatables/datatables/media/css/jquery.dataTables.min.css") }}">
    <link rel="stylesheet" href="{{ admin_asset("vendor/laravel-admin/parsley/parsley.css") }}">
    ...
    <!-- Custom REQUIRED JS SCRIPTS -->
    <script src="{{ admin_asset ("/vendor/laravel-admin/datatables/datatables/media/js/jquery.dataTables.min.js") }}"></script>
    <script src="{{ admin_asset ("/vendor/laravel-admin/chartjs/dist/Chart.bundle.min.js") }}"></script>
    <script src="{{ admin_asset ("/vendor/laravel-admin/parsley/parsley.min.js") }}"></script>
